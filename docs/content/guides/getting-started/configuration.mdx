...
| `database.runtime.redis.key_prefix` | `""` | Prefix applied to all Redis keys written by <ProductName />, for example `thunderid:` |
...
declarativeResources:
  enabled: true
  # Base mount path inside the ThunderID container (default: /opt/thunderid/repository/resources)
