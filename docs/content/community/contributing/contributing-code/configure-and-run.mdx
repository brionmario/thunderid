...
<CodeGroup>
  <CodeBlock lang="bash" label="Linux/macOS">
    {`SKIP_SECURITY=true THUNDER_API_BASE="https://localhost:8090" \\
...
2. Add the local development origin of the <ProductName /> Gate application (https://localhost:5190) to the CORS allowed origins in `<THUNDER_HOME>/repository/conf/deployment.yaml`.
