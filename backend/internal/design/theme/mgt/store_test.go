	...
	results := []map[string]interface{}{
		{
			...
			"theme":        `{"defaultColorScheme":"light","colorSchemes":{"light":{"palette":{"primary":{"main":"#ff7300"}}}}}`,
		...
		},
		{
			...
			"theme":        `{"defaultColorScheme":"dark","colorSchemes":{"dark":{"palette":{"primary":{"main":"#bb86fc"}}}}}`,
			"created_at":   "2024-01-15T10:30:00Z",
			"updated_at":   "2024-01-15T10:30:00Z",
		},
	}
