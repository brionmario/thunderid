  ...
  return (
    <Stack direction="column" spacing={4}>
      <Typography variant="h1" gutterBottom>
        {t('apis:create.orgUnit.title', 'Choose an organization unit')}
      </Typography>
      <Typography variant="body1" color="text.secondary">
        {t('apis:create.orgUnit.subtitle', 'Select which organization unit this API belongs to.')}
      </Typography>

      <FormControl fullWidth required>
        <FormLabel>{t('apis:create.orgUnit.fieldLabel', 'Organization Unit')}</FormLabel>
        <OrganizationUnitTreePicker
          id="api-create-ou-picker"
          value={selectedOuId}
