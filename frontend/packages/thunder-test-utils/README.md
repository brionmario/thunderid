...
consistent testing across all ThunderID apps.
...
- **Custom Render Functions** - Pre-configured render with all necessary providers (QueryClient, Router, Config, Logger,
  Theme)
- **App Configuration** - Configurable settings for different ThunderID apps (console, gate)
...
- **i18n initialization** - Pre-configured with all ThunderID translations
...
3. **ConfigProvider** - ThunderID configuration context
4. **LoggerProvider** - ThunderID logger with ERROR level for minimal test output
